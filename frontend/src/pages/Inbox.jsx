...
import { getMessages, getUser, isLoggedIn } from '../utils/api'
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden">
        {loading ? (
          ...
          <div className="p-12 text-center flex flex-col items-center">
            ...
            <p className="text-gray-500 dark:text-gray-400 max-w-sm">When users send you private messages about your items, they will appear here.</p>
          </div>
        ) : (
              ...
              <div key={msg.id} className="p-6 hover:bg-gray-50 dark:hover:bg-gray-750 transition-colors">
                <div className="flex justify-between items-start mb-3">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h4 className="font-bold text-gray-800 dark:text-gray-200">
                        {t('from') || 'From:'} <span className="text-blue-600 dark:text-blue-400">{msg.sender?.name || 'Unknown'}</span>
                      </h4>
                  ...
                  <div className="hidden sm:flex items-center gap-2 bg-gray-100 dark:bg-gray-700 px-3 py-1.5 rounded-full text-xs font-medium text-gray-600 dark:text-gray-300">
                    <Package size={14} /> {msg.item_title || msg.item?.title || 'General'}
                  </div>
                </div>
